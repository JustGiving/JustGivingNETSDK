...
{
    public class RegisterCampaignFundraisingPageRequest
    {
        /// <summary>
        ...
        /// <summary>
        ///  The causeId argument specifies the campaign you are creating a fundraising page for. (Required)
        /// </summary>
        public int CauseId { get; set; }
        /// <summary>
        ///  The companyAppealId argument specifies the company appeal you are creating a fundraising page for.
        /// </summary>
        ...
        /// </summary>
        public IList<PageRegistration.ImageInfo> Images { get; set; }

        /// <summary>
        /// Videos must be available over HTTPS and HTTP for optimal user experience
        /// </summary>
        public IList<PageRegistration.VideoInfo> Videos { get; set; }
        ...
        /// <summary>
        /// Correct the buggy v1 error response behaviour for consistency with the rest of the API.
        /// </summary>
        public bool ConsistentErrorResponses { get; set; }
        /// <summary>
